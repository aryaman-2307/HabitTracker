...
export default function LoginPage() {
  ...
  const [supabaseClient, setSupabaseClient] = useState<Awaited<ReturnType<typeof import("@/lib/supabase/client").createClient>> | null>(null);
  ...
  return (
    <div className="animate-in min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-amber-50/30 to-gray-50 dark:from-[#0a0a0c] dark:via-amber-950/10 dark:to-[#0a0a0c] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200/60 dark:border-gray-800 p-6">
          <button
            onClick={handleGoogleLogin}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors"
          >
          ...
          {magicLinkSent ? (
            <div className="text-center py-4">
              <p className="text-sm text-emerald-600 dark:text-emerald-400">Check your email for a magic link!</p>
            </div>
          ) : (
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              <button
                ...
                className="w-full py-2.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-xl text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
              >
                Send magic link
              </button>
            </form>
